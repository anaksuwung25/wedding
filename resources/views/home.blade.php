...
<script>
  // Jika ingin unmute setelah klik apa pun
            ...
            <div class="column">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-event" class='tab-content__item'>
                        ...
                        <div class="row">
                            <div class="column">
                                <p class="desc">
                                Besar harapan kami agar Bapak/Ibu/Saudara/i dapat meluangkan waktu untuk hadir dan berbagi kebahagiaan bersama kami di hari istimewa ini.
                                </p>
                            </div>
                        </div>
                    ...
                    <div id="tab-gallery" class="tab-content__item">
                        <div class="tz-gallery">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery7 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery7 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery8 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery8 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery9 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery9 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery10 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery10 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery11 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery11 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery12 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery12 }}">
                                    </a>
                                </div>
                            </div>
                    ...
                    <!-- 05 - tab gift -->
                    <div id="tab-rsvp" class="tab-content__item">
                ...
                <footer>
                    <div class="ss-copyright">
                        ...
                        @endforeach
                        <span>Developed by <a href="https://wa.me/6287823327307" target="_blank">anaksuwung</a></span>
                    </div>
                </footer>
